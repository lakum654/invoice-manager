...
!(function (o) {
    function e() {
        ...
        //     o("#status_fase").fadeOut(), o("#preloader").delay(350).fadeOut("slow");
        // });
    ...
    e(),
        ...
        jQuery().maxlength &&
        ((i = { warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", placement: "bottom" }),
                ...
                value: function () {
                    ...
                    s &&
                        ((e = document.querySelector("input[type=checkbox][name=data-layout][value=" + s.nav + "]")),
                            ...
                            (n = document.querySelector("input[type=checkbox][name=data-layout-mode][value=" + s.layout.mode + "]")),
                            (a = document.querySelector("input[type=checkbox][name=data-topbar-color][value=" + s.topbar.color + "]")),
                            (o = document.querySelector("input[type=checkbox][name=data-menu-color][value=" + s.menu.color + "]")),
                            (r = document.querySelector("input[type=checkbox][name=data-sidenav-size][value=" + s.sidenav.size + "]")),
